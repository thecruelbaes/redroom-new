          ...
          <div className="mt-8 max-w-xl rounded-2xl hairline-strong bg-surface/70 p-5 backdrop-blur-md">
            <div className="flex items-start gap-3">
              ...
              <p className="text-[15px] leading-relaxed text-ink">
                <span className="font-semibold">Первое занятие — бесплатно.</span> Придёте, попробуете
                инструмент, познакомитесь с преподавателем — и сами решите, ваше это или нет. Без предоплаты
